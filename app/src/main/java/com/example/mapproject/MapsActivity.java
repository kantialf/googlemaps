...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng tuguJogja = new LatLng(-7.797068, 110.370529);
        LatLng cililin = new LatLng(-6.98345, 107.453364);
        LatLng gdSate = new LatLng(-6.899925, 107.622966);
        mMap.addMarker(new MarkerOptions().position(gdSate).title("Marker in Gedung Sate"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(gdSate));
